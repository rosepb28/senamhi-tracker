...
def upgrade():
    op.create_table(
        ...
        sa.UniqueConstraint('warning_number', 'department', 'day_number', name='uq_warning_dept_day')
    )
    
    op.create_index(
        'ix_warning_daily_details_warning',
        'warning_daily_details',
        ['warning_number']
    )
    
    op.create_index(
        'ix_warning_daily_details_dept',
        'warning_daily_details',
        ['department']
    )
...
def downgrade():
    ...
    op.drop_index('ix_warning_daily_details_warning', table_name='warning_daily_details')
