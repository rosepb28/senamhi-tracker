...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_warnings_issued_at'), 'warnings', ['issued_at'], unique=False)
    op.create_index(op.f('ix_warnings_severity'), 'warnings', ['severity'], unique=False)
    op.create_index(op.f('ix_warnings_status'), 'warnings', ['status'], unique=False)
    op.create_index(op.f('ix_warnings_valid_from'), 'warnings', ['valid_from'], unique=False)
    op.create_index(op.f('ix_warnings_valid_until'), 'warnings', ['valid_until'], unique=False)
    op.create_index(op.f('ix_warnings_warning_number'), 'warnings', ['warning_number'], unique=True)
